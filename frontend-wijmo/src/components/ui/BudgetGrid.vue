<template>
    <div style="max-height:80vh;">
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['RowHeader','governmentSupportAmount','privateRatio','privateCashRatio','laborCost','internalLaborCost','externalLaborCost','studentResearchCost','materialCost','researchFacilityCost','activityCost','indirectCost','projectMasterId',]" />
            <wj-flex-grid-cell-template cellType="RowHeader" v-slot="cell">{{cell.row.index + 1}}</wj-flex-grid-cell-template>
            <wj-flex-grid-column binding="governmentSupportAmount" header="정부지원금" width="2*" :isReadOnly="true" align="center" />
