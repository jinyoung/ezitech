<template>
    <div style="max-height:80vh;">
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['RowHeader','date','author','content','signature','approvalStatus',]" />
            <wj-flex-grid-cell-template cellType="RowHeader" v-slot="cell">{{cell.row.index + 1}}</wj-flex-grid-cell-template>
            <wj-flex-grid-column binding="date" header="일자" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="author" header="작성자" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="content" header="내용" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="signature" header="서명" width="2*" :isReadOnly="true" align="center" />
                ...
                <template>
                    <v-card>
                        <v-toolbar
                            ...
                            height="50px"
                        >
                            <div style="color:white; font-size:17px; font-weight:700;">연구노트 등록</div>
                            <v-spacer></v-spacer>
                            <v-icon
                                color="white"
                                small
