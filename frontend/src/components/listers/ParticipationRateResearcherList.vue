                ...
                <v-list-item v-for="(data, n) in values" :key="n">
                    ...
                    <v-list-item-content>
                        ...
                        <v-list-item-subtitle style="font-size:25px; font-weight:700;">
                            ...
                            [ HighestEducationSchool :  {{data.highestEducationSchool }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            [ HighestEducationMajor :  {{data.highestEducationMajor }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            [ MonthlySalary :  {{data.monthlySalary }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            [ PhysicalAllowanceRate :  {{data.physicalAllowanceRate }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            [ CashAllowanceRate :  {{data.cashAllowanceRate }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            [ Duration :  {{data.duration }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            [ Department :  {{data.department }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            [ ResearcherNumber :  {{data.researcherNumber }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
