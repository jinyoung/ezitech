<template>
    <v-card outlined @click="openDialog">
        <v-card-title>
            ProjectMaster : {{ referenceValue ? referenceValue.name : '' }}
        </v-card-title>

        <v-dialog v-model="pickerDialog">
            <v-card>
                <v-card-title>ProjectMaster</v-card-title>
                <v-card-text>
                    <ProjectMasterPicker v-model="value" @selected="pick"/>
                </v-card-text>
                <v-card-actions>
                    <v-spacer></v-spacer>
